...
def get_api_key_dependency(api_key: Optional[str]):
    ...
    async def api_key_auth(api_key_header_value: Optional[str] = Security(api_key_header)):
...
def create_app(args):
    ...
    logger = logging.getLogger("minirag_api") # Define the logger instance
    ...
    @trace_exception(trace_logger=logger.error)
